...
IMPACT is an improved framework for distributed aberration correction that relies on tomographic sound speed estimates. Our previous work (see https://github.com/rehmanali1994/DistributedAberrationCorrection) relies on coherence factor maximization to estimate a focusing sound speed at each imaging point. This focusing sound speed is then used to reconstruct the spatial profile of local sound speed in the tissue. However, the performance of this approach quickly breaks down in the presence of lateral sound speed variations.
